...
namespace Lucene
{
    ...
    DECLARE_SHARED_PTR(ClassicAnalyzer)
    DECLARE_SHARED_PTR(ClassicFilter)
    DECLARE_SHARED_PTR(ClassicTokenizer)
    DECLARE_SHARED_PTR(ClassicTokenizerImpl)
    ...
    DECLARE_SHARED_PTR(KeywordMarkerFilter)
    DECLARE_SHARED_PTR(KeywordTokenizer)
    DECLARE_SHARED_PTR(LengthFilter)
    DECLARE_SHARED_PTR(LetterTokenizer)
    DECLARE_SHARED_PTR(LimitTokenCountAnalyzer)
    DECLARE_SHARED_PTR(LimitTokenCountFilter)
    ...
    DECLARE_SHARED_PTR(ReusableAnalyzerBase)
    ...
    DECLARE_SHARED_PTR(StandardTokenizerInterface)
    DECLARE_SHARED_PTR(StopAnalyzer)
    DECLARE_SHARED_PTR(StopwordAnalyzerBase)
    ...
    DECLARE_SHARED_PTR(UAX29URLEmailTokenizer)
    ...
    DECLARE_SHARED_PTR(DirPayloadProcessor)
    ...
    DECLARE_SHARED_PTR(FlushControl)
    ...
    DECLARE_SHARED_PTR(FreqProxPostingsArray)
    ...
    DECLARE_SHARED_PTR(IndexWriterConfig)
    ...
    DECLARE_SHARED_PTR(ParallelPostingsArray)
    ...
    DECLARE_SHARED_PTR(PayloadProcessor)
    DECLARE_SHARED_PTR(PayloadProcessorProvider)
    DECLARE_SHARED_PTR(PerDocBuffer)
    DECLARE_SHARED_PTR(PersistentSnapshotDeletionPolicy)
    DECLARE_SHARED_PTR(PositionBasedTermVectorMapper)
    DECLARE_SHARED_PTR(ReaderCommit)
    DECLARE_SHARED_PTR(ReaderFinishedListener)
    ...
    DECLARE_SHARED_PTR(SegmentDeletes)
    ...
    DECLARE_SHARED_PTR(SnapshotCommitPoint)
    DECLARE_SHARED_PTR(SnapshotDeletionPolicy)
    DECLARE_SHARED_PTR(SnapshotInfo)
    ...
    DECLARE_SHARED_PTR(TermInfoAndOrd)
    ...
    DECLARE_SHARED_PTR(TermVectorsPostingsArray)
    ...
    DECLARE_SHARED_PTR(CutOffTermCollector)
    ...
    DECLARE_SHARED_PTR(DocumentFrequencyCallable)
    ...
    DECLARE_SHARED_PTR(MultiCollector)
    DECLARE_SHARED_PTR(MultiComparatorsFieldValueHitQueue)
    DECLARE_SHARED_PTR(MultiIndexSearcherCallableNoSort)
    DECLARE_SHARED_PTR(MultiIndexSearcherCallableWithSort)
    ...
    DECLARE_SHARED_PTR(ScorerVisitor)
    DECLARE_SHARED_PTR(ScoreTerm)
    DECLARE_SHARED_PTR(ScoreTermQueue)
    DECLARE_SHARED_PTR(ScoringRewrite)
    DECLARE_SHARED_PTR(ScoringSpanOrQuery)
    ...
    DECLARE_SHARED_PTR(SpanMultiTermQueryWrapper)
    DECLARE_SHARED_PTR(SpanNearPayloadCheckQuery)
    DECLARE_SHARED_PTR(SpanNearQuery)    
    DECLARE_SHARED_PTR(SpanNotQuery)
    DECLARE_SHARED_PTR(SpanOrQuery)    
    DECLARE_SHARED_PTR(SpanPositionCheckQuery)
    DECLARE_SHARED_PTR(SpanPositionRangeQuery)
    DECLARE_SHARED_PTR(SpanQuery)
    DECLARE_SHARED_PTR(SpanQueryFilter)
    DECLARE_SHARED_PTR(SpanQueue)
    DECLARE_SHARED_PTR(SpanRewriteMethod)
    ...
    DECLARE_SHARED_PTR(TermCollector)
    ...
    DECLARE_SHARED_PTR(TopTermsRewrite)
    DECLARE_SHARED_PTR(TopTermsSpanBooleanQueryRewrite)
    DECLARE_SHARED_PTR(TotalHitCountCollector)
    ...
    DECLARE_SHARED_PTR(FSIndexOutput)
