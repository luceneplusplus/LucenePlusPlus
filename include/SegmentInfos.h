...
namespace Lucene
{
    ...
    class LPPAPI SegmentInfos : public SegmentInfoCollection
    {
    public:
        SegmentInfos();
    ...
    public:
        ...
        SetString files(DirectoryPtr dir, bool includeSegmentsFile);
        ...
        static int64_t getCurrentSegmentGeneration(SetString files);
        static int64_t getCurrentSegmentGeneration(DirectoryPtr directory);
        static String getCurrentSegmentFileName(SetString files);
