...
namespace Lucene
{
    ...
    {
        #ifdef LPP_USE_GC
        return Lucene::gc_ptr<T>(new(GC) T);
        #else
    ...
    {
        #ifdef LPP_USE_GC
        return Lucene::gc_ptr<T>(new(GC) T(a1));
        #else
        #if BOOST_VERSION <= 103800
    ...
    {
        #ifdef LPP_USE_GC
        return Lucene::gc_ptr<T>(new(GC) T(a1, a2));
        #else
        #if BOOST_VERSION <= 103800
    ...
    {
        #ifdef LPP_USE_GC
        return Lucene::gc_ptr<T>(new(GC) T(a1, a2, a3));
        #else
        #if BOOST_VERSION <= 103800
    ...
    {
        #ifdef LPP_USE_GC
        return Lucene::gc_ptr<T>(new(GC) T(a1, a2, a3, a4));
        #else
        #if BOOST_VERSION <= 103800
    ...
    {
        #ifdef LPP_USE_GC
        return Lucene::gc_ptr<T>(new(GC) T(a1, a2, a3, a4, a5));
        #else
        #if BOOST_VERSION <= 103800
    ...
    {
        #ifdef LPP_USE_GC
        return Lucene::gc_ptr<T>(new(GC) T(a1, a2, a3, a4, a5, a6));
        #else
        #if BOOST_VERSION <= 103800
    ...
    {
        #ifdef LPP_USE_GC
        return Lucene::gc_ptr<T>(new(GC) T(a1, a2, a3, a4, a5, a6, a7));
        #else
        #if BOOST_VERSION <= 103800
    ...
    {
        #ifdef LPP_USE_GC
        return Lucene::gc_ptr<T>(new(GC) T(a1, a2, a3, a4, a5, a6, a7, a8));
        #else
        #if BOOST_VERSION <= 103800
    ...
    {
        #ifdef LPP_USE_GC
        return Lucene::gc_ptr<T>(new(GC) T(a1, a2, a3, a4, a5, a6, a7, a8, a9));
        #else
        #if BOOST_VERSION <= 103800
