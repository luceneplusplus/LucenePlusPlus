...
namespace Lucene
{
    ...
    public:
        ...
        /// Similarity#encodeNormValue(double)} before it is stored in the before it is stored in the index.
        /// One should attempt to ensure that this product does not overflow the range of that encoding.
        ///
