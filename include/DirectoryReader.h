...
namespace Lucene
{
    ...
    public:
        ...
        /// option information.
        virtual SetString getFieldNames(FieldOption fieldOption);

        static SetString getFieldNames(FieldOption fieldOption, Collection<IndexReaderPtr> subReaders);
    ...
    protected:
        IndexReaderPtr topReader; // used for matching TermEnum to TermDocs
