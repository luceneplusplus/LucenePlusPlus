...
namespace Lucene
{
    ...
    class LPPAPI ParallelTermEnum : public TermEnum
    {
    public:
    ...
    class LPPAPI ParallelTermDocs : public TermPositions, public LuceneObject
    {
    public:
    ...
    class LPPAPI ParallelTermPositions : public ParallelTermDocs
    {
    public:
