...
namespace Lucene
{
    ...
    protected:
        ...
        SetString synced; // files that have been sync'd already
        SetString syncing; // files that are now being sync'd
