...
namespace Lucene
{
	...
	public:
		...
		/// are in fact <= or >= queries) by setting the min or max value to Lucene::Blank(). By setting 
	...
	class LPPAPI NumericLongRangeBuilder : public LongRangeBuilder
	{
	public:
	...
	class LPPAPI NumericIntRangeBuilder : public IntRangeBuilder
	{
	public:
