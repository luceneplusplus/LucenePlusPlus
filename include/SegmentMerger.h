...
namespace Lucene
{
    ...
    public:
        ...
        SetString getMergedFiles();
        SetString createCompoundFile(const String& fileName);
    ...
    protected:
        void addIndexed(IndexReaderPtr reader, FieldInfosPtr fInfos, SetString names, bool storeTermVectors,
