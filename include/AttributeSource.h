...
namespace Lucene
{
    ...
    class LPPAPI AttributeSource : public LuceneObject
    {
    public:
    ...
    public:
        ...
        template <class ATTR>
        LucenePtr<ATTR> addAttribute()
        {
            String className(ATTR::_getClassName());            
            LucenePtr<ATTR> attrImpl(LuceneDynamicCast<ATTR>(getAttribute(className)));
            if (!attrImpl)
            {
        ...
        template <class ATTR>
        LucenePtr<ATTR> getAttribute()
        {
            String className(ATTR::_getClassName());
            LucenePtr<ATTR> attr(LuceneDynamicCast<ATTR>(getAttribute(className)));
            if (!attr)
    ...
    class LPPAPI DefaultAttributeFactory : public AttributeFactory
    {
    public:
    ...
    /// @see #captureState
    /// @see #restoreState
    class LPPAPI AttributeSourceState : public LuceneObject
    {
    public:
