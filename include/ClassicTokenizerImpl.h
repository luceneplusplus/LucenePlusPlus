...
#ifndef CLASSICTOKENIZERIMPL_H
#define CLASSICTOKENIZERIMPL_H

#include "StandardTokenizerInterface.h"

namespace Lucene
{
    class ClassicTokenizerImpl : public StandardTokenizerInterface
    {
    public:
        /// Creates a new scanner
        /// @param in the Reader to read input from.
        ClassicTokenizerImpl(ReaderPtr in);
        
        virtual ~ClassicTokenizerImpl();
        
        LUCENE_CLASS(ClassicTokenizerImpl);
    ...
    public:
        ...
        /// of input is encountered or an I/O-
        /// Error occurs.
