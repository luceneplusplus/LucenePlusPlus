...
namespace Lucene
{
    ...
    public:
        ...
        static const SetString INDEX_EXTENSIONS();

        /// File extensions that are added to a compound file (same as
        /// {@link #INDEX_EXTENSIONS}, minus "del", "gen", "cfs").
        static const SetString INDEX_EXTENSIONS_IN_COMPOUND_FILE();

        static const SetString STORE_INDEX_EXTENSIONS();
        static const SetString NON_STORE_INDEX_EXTENSIONS();

        /// File extensions of old-style index files.
        static const SetString COMPOUND_EXTENSIONS();

        /// File extensions for term vector support.
        static const SetString VECTOR_EXTENSIONS();
