...
namespace Lucene
{
    ...
    void NumericUtils::addRange(LuceneObjectPtr builder, int32_t valSize, int64_t minBound, int64_t maxBound, int32_t shift)
    {
        ...
        {
            case 64:
                boost::static_pointer_cast<LongRangeBuilder>(builder)->addRange(minBound, maxBound, shift);
                break;
            case 32:
                boost::static_pointer_cast<IntRangeBuilder>(builder)->addRange((int32_t)minBound, (int32_t)maxBound, shift);
                break;
            default:
