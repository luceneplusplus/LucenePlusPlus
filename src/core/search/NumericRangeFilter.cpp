...
namespace Lucene
{
    ...
    {
        return gc_ptr_static_cast<NumericRangeQuery>(query)->field;
    }

    bool NumericRangeFilter::includesMin()
    {
        return gc_ptr_static_cast<NumericRangeQuery>(query)->minInclusive;
    }

    bool NumericRangeFilter::includesMax()
    {
        return gc_ptr_static_cast<NumericRangeQuery>(query)->maxInclusive;
    }

    NumericValue NumericRangeFilter::getMin()
    {
        return gc_ptr_static_cast<NumericRangeQuery>(query)->min;
    }
