...
namespace Lucene
{
    ...
    {
        this->parser = gc_ptr_static_cast<ByteParser>(parser);
    }
    ...
    {
        this->parser = gc_ptr_static_cast<DoubleParser>(parser);
    }
    ...
    {
        this->parser = gc_ptr_static_cast<IntParser>(parser);
    }
    ...
    {
        this->parser = gc_ptr_static_cast<LongParser>(parser);
    }
