...
namespace Lucene
{
    FileSwitchDirectory::FileSwitchDirectory(SetString primaryExtensions, DirectoryPtr primaryDir, DirectoryPtr secondaryDir, bool doClose)
    {
    ...
    SetString FileSwitchDirectory::listAll()
    {
