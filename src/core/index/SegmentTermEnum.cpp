...
namespace Lucene
{
    ...
    LuceneObjectPtr SegmentTermEnum::clone(LuceneObjectPtr other)
    {
        ...
        SegmentTermEnumPtr cloneEnum(boost::static_pointer_cast<SegmentTermEnum>(TermEnum::clone(clone)));
        ...
        cloneEnum->input = boost::static_pointer_cast<IndexInput>(input->clone());
        cloneEnum->_termInfo = newLucene<TermInfo>(_termInfo);
        
        cloneEnum->termBuffer = boost::static_pointer_cast<TermBuffer>(termBuffer->clone());
        cloneEnum->prevBuffer = boost::static_pointer_cast<TermBuffer>(prevBuffer->clone());
