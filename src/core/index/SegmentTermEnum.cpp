...
namespace Lucene
{
    ...
    LuceneObjectPtr SegmentTermEnum::clone(LuceneObjectPtr other)
    {
        ...
        SegmentTermEnumPtr cloneEnum(gc_ptr_dynamic_cast<SegmentTermEnum>(TermEnum::clone(clone)));
        ...
        cloneEnum->input = gc_ptr_dynamic_cast<IndexInput>(input->clone());
        cloneEnum->_termInfo = newLucene<TermInfo>(_termInfo);

        cloneEnum->termBuffer = gc_ptr_dynamic_cast<TermBuffer>(termBuffer->clone());
        cloneEnum->prevBuffer = gc_ptr_dynamic_cast<TermBuffer>(prevBuffer->clone());
