...
namespace Lucene
{
    ...
    const SetString IndexFileNames::INDEX_EXTENSIONS()
    {
        static SetString _INDEX_EXTENSIONS;
        if (!_INDEX_EXTENSIONS)
        {
            _INDEX_EXTENSIONS = SetString::newStaticInstance();
    ...
    const SetString IndexFileNames::INDEX_EXTENSIONS_IN_COMPOUND_FILE()
    {
        static SetString _INDEX_EXTENSIONS_IN_COMPOUND_FILE;
        if (!_INDEX_EXTENSIONS_IN_COMPOUND_FILE)
        {
            _INDEX_EXTENSIONS_IN_COMPOUND_FILE = SetString::newStaticInstance();
    ...
    const SetString IndexFileNames::STORE_INDEX_EXTENSIONS()
    {
        static SetString _STORE_INDEX_EXTENSIONS;
        if (!_STORE_INDEX_EXTENSIONS)
        {
            _STORE_INDEX_EXTENSIONS = SetString::newStaticInstance();
    ...
    const SetString IndexFileNames::NON_STORE_INDEX_EXTENSIONS()
    {
        static SetString _NON_STORE_INDEX_EXTENSIONS;
        if (!_NON_STORE_INDEX_EXTENSIONS)
        {
            _NON_STORE_INDEX_EXTENSIONS = SetString::newStaticInstance();
    ...
    const SetString IndexFileNames::COMPOUND_EXTENSIONS()
    {
        static SetString _COMPOUND_EXTENSIONS;
        if (!_COMPOUND_EXTENSIONS)
        {
            _COMPOUND_EXTENSIONS = SetString::newStaticInstance();
    ...
    const SetString IndexFileNames::VECTOR_EXTENSIONS()
    {
        static SetString _VECTOR_EXTENSIONS;
        if (!_VECTOR_EXTENSIONS)
        {
            _VECTOR_EXTENSIONS = SetString::newStaticInstance();
    ...
    bool IndexFileNames::isDocStoreFile(const String& fileName)
    {
        if (boost::ends_with(fileName, COMPOUND_FILE_STORE_EXTENSION()))
            return true;
        for (SetString::iterator index = STORE_INDEX_EXTENSIONS().begin(); index != STORE_INDEX_EXTENSIONS().end(); ++index)
        {
