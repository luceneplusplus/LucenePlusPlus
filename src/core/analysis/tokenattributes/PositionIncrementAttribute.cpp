...
namespace Lucene
{
    ...
    {
        PositionIncrementAttributePtr targetPositionIncrementAttribute(boost::static_pointer_cast<PositionIncrementAttribute>(target));
    ...
    LuceneObjectPtr PositionIncrementAttribute::clone(LuceneObjectPtr other)
    {
        ...
        PositionIncrementAttributePtr cloneAttribute(boost::static_pointer_cast<PositionIncrementAttribute>(Attribute::clone(clone)));
