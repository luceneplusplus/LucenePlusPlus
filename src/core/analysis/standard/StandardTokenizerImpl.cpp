...
namespace Lucene
{
    ...
    const int32_t* StandardTokenizerImpl::ZZ_ACTION()
    {
        ...
        if (!_ZZ_ACTION)
        {
            _ZZ_ACTION = IntArray::newStaticInstance(ZZ_ACTION_LENGTH);
    ...
    const  int32_t* StandardTokenizerImpl::ZZ_ROWMAP()
    {
        ...
        if (!_ZZ_ROWMAP)
        {
            _ZZ_ROWMAP = IntArray::newStaticInstance(ZZ_ROWMAP_LENGTH);
    ...
    const int32_t* StandardTokenizerImpl::ZZ_TRANS()
    {
        ...
        if (!_ZZ_TRANS)
        {
            _ZZ_TRANS = IntArray::newStaticInstance(ZZ_TRANS_LENGTH);
    ...
    const int32_t* StandardTokenizerImpl::ZZ_ATTRIBUTE()
    {
        ...
        if (!_ZZ_ATTRIBUTE)
        {
            _ZZ_ATTRIBUTE = IntArray::newStaticInstance(ZZ_ATTRIBUTE_LENGTH);
