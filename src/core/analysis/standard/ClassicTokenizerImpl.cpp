...
namespace Lucene
{
    const int32_t ClassicTokenizerImpl::ZZ_LEXSTATE[] = 
    {
        0, 0
    };
    
    /// Initial size of the lookahead buffer
    const int32_t ClassicTokenizerImpl::ZZ_BUFFERSIZE = 16384;
    
    /// Translates characters to character classes
    const wchar_t ClassicTokenizerImpl::ZZ_CMAP_PACKED[] = 
    {
    ...
    const int32_t ClassicTokenizerImpl::ZZ_CMAP_LENGTH = 65536;
    const int32_t ClassicTokenizerImpl::ZZ_CMAP_PACKED_LENGTH = 1154;
    
    const wchar_t ClassicTokenizerImpl::ZZ_ACTION_PACKED_0[] = 
    {
    ...
    const int32_t ClassicTokenizerImpl::ZZ_ACTION_LENGTH = 51;
    const int32_t ClassicTokenizerImpl::ZZ_ACTION_PACKED_LENGTH = 50;
    
    const wchar_t ClassicTokenizerImpl::ZZ_ROWMAP_PACKED_0[] = 
    {
    ...
    const int32_t ClassicTokenizerImpl::ZZ_ROWMAP_LENGTH = 51;
    const int32_t ClassicTokenizerImpl::ZZ_ROWMAP_PACKED_LENGTH = 102;
    
    const wchar_t ClassicTokenizerImpl::ZZ_TRANS_PACKED_0[] = 
    {
    ...
    const int32_t ClassicTokenizerImpl::ZZ_TRANS_LENGTH = 658;
    const int32_t ClassicTokenizerImpl::ZZ_TRANS_PACKED_LENGTH = 634;
    
    const int32_t ClassicTokenizerImpl::ZZ_UNKNOWN_ERROR = 0;
    const int32_t ClassicTokenizerImpl::ZZ_NO_MATCH = 1;
    const int32_t ClassicTokenizerImpl::ZZ_PUSHBACK_2BIG = 2;
    
    const wchar_t* ClassicTokenizerImpl::ZZ_ERROR_MSG[] = 
    {
    ...
    const wchar_t ClassicTokenizerImpl::ZZ_ATTRIBUTE_PACKED_0[] = 
    {
        L"\1\0\1\11\3\1\1\11\1\1\13\0\4\1\2\0"
        L"\1\1\1\0\17\1\1\0\1\1\3\0\5\1"
    };
    
    const int32_t ClassicTokenizerImpl::ZZ_ATTRIBUTE_LENGTH = 51;
    const int32_t ClassicTokenizerImpl::ZZ_ATTRIBUTE_PACKED_LENGTH = 30;
    
    /// Lexical states
    const int32_t ClassicTokenizerImpl::YYINITIAL = 0;
    
    ClassicTokenizerImpl::ClassicTokenizerImpl(ReaderPtr in)
    {
        this->zzState = 0;
    ...
    ClassicTokenizerImpl::~ClassicTokenizerImpl()
    {
    }
    
    const wchar_t* ClassicTokenizerImpl::ZZ_CMAP()
    {
    ...
    const int32_t* ClassicTokenizerImpl::ZZ_ACTION()
    {
    ...
    const  int32_t* ClassicTokenizerImpl::ZZ_ROWMAP()
    {
    ...
    const int32_t* ClassicTokenizerImpl::ZZ_TRANS()
    {
    ...
    const int32_t* ClassicTokenizerImpl::ZZ_ATTRIBUTE()
    {
    ...
    int32_t ClassicTokenizerImpl::yychar()
    {
        return _yychar;
    }
    
    void ClassicTokenizerImpl::getText(CharTermAttributePtr t)
    {
    ...
    void ClassicTokenizerImpl::yyreset(ReaderPtr reader)
    {
        zzReader = reader;
        zzAtBOL = true;
        zzAtEOF = false;
    ...
    int32_t ClassicTokenizerImpl::yystate()
    {
        return zzLexicalState;
    }
    
    void ClassicTokenizerImpl::yybegin(int32_t newState)
    {
        zzLexicalState = newState;
    }
    
    String ClassicTokenizerImpl::yytext()
    {
        return String(zzBuffer.get() + zzStartRead, zzMarkedPos - zzStartRead);
    }
    
    wchar_t ClassicTokenizerImpl::yycharat(int32_t pos)
    {
        return zzBuffer[zzStartRead + pos];
    }
    
    int32_t ClassicTokenizerImpl::yylength()
    {
        return zzMarkedPos - zzStartRead;
    }
    
    void ClassicTokenizerImpl::zzScanError(int32_t errorCode)
    {
        boost::throw_exception(ParseException(ZZ_ERROR_MSG[errorCode]));
    }
    
    void ClassicTokenizerImpl::yypushback(int32_t number)
    {
        if (number > yylength())
    ...
    int32_t ClassicTokenizerImpl::getNextToken()
    {
        int32_t zzInput;
        int32_t zzAction;
