...
namespace Lucene
{
    ClassicFilter::ClassicFilter(TokenStreamPtr input) : TokenFilter(input)
    {
    ...
    const String& ClassicFilter::APOSTROPHE_TYPE()
    {
        static String _APOSTROPHE_TYPE;
        if (_APOSTROPHE_TYPE.empty())
            _APOSTROPHE_TYPE = ClassicTokenizer::TOKEN_TYPES()[ClassicTokenizer::APOSTROPHE];
        return _APOSTROPHE_TYPE;
    }
    
    const String& ClassicFilter::ACRONYM_TYPE()
    {
        static String _ACRONYM_TYPE;
        if (_ACRONYM_TYPE.empty())
            _ACRONYM_TYPE = ClassicTokenizer::TOKEN_TYPES()[ClassicTokenizer::ACRONYM];
