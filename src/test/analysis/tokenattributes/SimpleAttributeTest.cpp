...
BOOST_AUTO_TEST_CASE(testFlagsAttribute)
{
    ...
    FlagsAttributePtr att2 = boost::static_pointer_cast<FlagsAttribute>(checkCloneIsEqual(att));
    BOOST_CHECK_EQUAL(1234, att2->getFlags());

    att2 = boost::static_pointer_cast<FlagsAttribute>(checkCopyIsEqual<FlagsAttribute>(att));
    BOOST_CHECK_EQUAL(1234, att2->getFlags());
...
BOOST_AUTO_TEST_CASE(testPositionIncrementAttribute)
{
    ...
    PositionIncrementAttributePtr att2 = boost::static_pointer_cast<PositionIncrementAttribute>(checkCloneIsEqual(att));
    BOOST_CHECK_EQUAL(1234, att2->getPositionIncrement());

    att2 = boost::static_pointer_cast<PositionIncrementAttribute>(checkCopyIsEqual<PositionIncrementAttribute>(att));
    BOOST_CHECK_EQUAL(1234, att2->getPositionIncrement());
...
BOOST_AUTO_TEST_CASE(testTypeAttribute)
{
    ...
    TypeAttributePtr att2 = boost::static_pointer_cast<TypeAttribute>(checkCloneIsEqual(att));
    BOOST_CHECK_EQUAL(L"hello", att2->type());

    att2 = boost::static_pointer_cast<TypeAttribute>(checkCopyIsEqual<TypeAttribute>(att));
    BOOST_CHECK_EQUAL(L"hello", att2->type());
...
BOOST_AUTO_TEST_CASE(testPayloadAttribute)
{
    ...
    PayloadAttributePtr att2 = boost::static_pointer_cast<PayloadAttribute>(checkCloneIsEqual(att));
    BOOST_CHECK(pl->equals(att2->getPayload()));
    BOOST_CHECK_NE(pl, att2->getPayload());

    att2 = boost::static_pointer_cast<PayloadAttribute>(checkCopyIsEqual<PayloadAttribute>(att));
    BOOST_CHECK(pl->equals(att2->getPayload()));
    BOOST_CHECK_NE(pl, att2->getPayload());
...
BOOST_AUTO_TEST_CASE(testOffsetAttribute)
{
    ...
    OffsetAttributePtr att2 = boost::static_pointer_cast<OffsetAttribute>(checkCloneIsEqual(att));
    BOOST_CHECK_EQUAL(12, att2->startOffset());
    BOOST_CHECK_EQUAL(34, att2->endOffset());

    att2 = boost::static_pointer_cast<OffsetAttribute>(checkCopyIsEqual<OffsetAttribute>(att));
    BOOST_CHECK_EQUAL(12, att2->startOffset());
    BOOST_CHECK_EQUAL(34, att2->endOffset());
