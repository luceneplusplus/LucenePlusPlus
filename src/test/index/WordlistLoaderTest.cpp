...
static void checkSet(SetString wordset)
{
...
{
    String s = L"ONE\n  two \nthree";
    SetString wordSet1 = WordlistLoader::getWordSet(newLucene<StringReader>(s));
    checkSet(wordSet1);
    SetString wordSet2 = WordlistLoader::getWordSet(newLucene<BufferedReader>(newLucene<StringReader>(s)));
    checkSet(wordSet2);
}
...
{
    String s = L"ONE\n  two \nthree\n#comment";
    SetString wordSet1 = WordlistLoader::getWordSet(newLucene<StringReader>(s), L"#");
    checkSet(wordSet1);
