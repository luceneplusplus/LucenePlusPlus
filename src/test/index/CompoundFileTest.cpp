...
public:
    ...
    bool isCSIndexInputOpen(IndexInputPtr is)
    {
        ...
        {
            CSIndexInputPtr cis = boost::static_pointer_cast<CSIndexInput>(is);
    ...
    bool isSimpleFSIndexInputOpen(IndexInputPtr is)
    {
        ...
        {
            SimpleFSIndexInputPtr fis = boost::static_pointer_cast<SimpleFSIndexInput>(is);
            return fis->isValid();
        }
        else
            return false;
...
BOOST_AUTO_TEST_CASE(testClonedStreamsClosing)
{
    ...
    IndexInputPtr two = boost::static_pointer_cast<IndexInput>(one->clone());
...
BOOST_AUTO_TEST_CASE(testRandomAccessClones)
{
    ...
    IndexInputPtr a1 = boost::static_pointer_cast<IndexInput>(e1->clone());
    IndexInputPtr a2 = boost::static_pointer_cast<IndexInput>(e2->clone());
