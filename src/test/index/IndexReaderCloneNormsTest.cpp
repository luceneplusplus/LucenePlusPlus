...
public:
    ...
    void doTestNorms(DirectoryPtr dir)
    {
        ...
        verifyIndex(ir);
        modifyNormsForF1(ir);
        IndexReaderPtr irc = boost::static_pointer_cast<IndexReader>(ir->clone());
        verifyIndex(irc);

        modifyNormsForF1(irc);

        IndexReaderPtr irc3 = boost::static_pointer_cast<IndexReader>(irc->clone());
        verifyIndex(irc3);
...
BOOST_AUTO_TEST_CASE(testNormsClose)
{
    ...
    // todo SegmentReaderRefPtr r1BytesRef = r1norm->bytesRef();
    SegmentReaderPtr reader2 = boost::static_pointer_cast<SegmentReader>(reader1->clone());
...
BOOST_AUTO_TEST_CASE(testNormsRefCounting)
{
    ...
    IndexReaderPtr reader2C = boost::static_pointer_cast<IndexReader>(reader1->clone());
    ...
    IndexReaderPtr reader3C = boost::static_pointer_cast<IndexReader>(reader2C->clone());
    ...
    IndexReaderPtr reader4C = boost::static_pointer_cast<IndexReader>(reader3C->clone());
    ...
    IndexReaderPtr reader5C = boost::static_pointer_cast<IndexReader>(reader4C->clone());
