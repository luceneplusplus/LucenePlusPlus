...
public:
    ...
    void doTestNorms(DirectoryPtr dir)
    {
        ...
        verifyIndex(ir);
        modifyNormsForF1(ir);
        IndexReaderPtr irc = gc_ptr_dynamic_cast<IndexReader>(ir->clone());
        verifyIndex(irc);

        modifyNormsForF1(irc);

        IndexReaderPtr irc3 = gc_ptr_dynamic_cast<IndexReader>(irc->clone());
        verifyIndex(irc3);
...
BOOST_AUTO_TEST_CASE(testNormsClose)
{
    ...
    SegmentReaderPtr reader2 = gc_ptr_dynamic_cast<SegmentReader>(reader1->clone());
...
BOOST_AUTO_TEST_CASE(testNormsRefCounting)
{
    ...
    IndexReaderPtr reader2C = gc_ptr_dynamic_cast<IndexReader>(reader1->clone());
    ...
    IndexReaderPtr reader3C = gc_ptr_dynamic_cast<IndexReader>(reader2C->clone());
    ...
    IndexReaderPtr reader4C = gc_ptr_dynamic_cast<IndexReader>(reader3C->clone());
    ...
    IndexReaderPtr reader5C = gc_ptr_dynamic_cast<IndexReader>(reader4C->clone());
