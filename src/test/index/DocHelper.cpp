...
namespace Lucene
{
    ...
    void DocHelper::setup()
    {
        ...
        UTF8ResultPtr utf8 = new_gc<UTF8Result>();
        ...
        nameValues.put(String(TEXT_FIELD_2_KEY), String(FIELD_2_TEXT));
        nameValues.put(String(TEXT_FIELD_3_KEY), String(FIELD_3_TEXT));
        nameValues.put(String(KEYWORD_FIELD_KEY), String(KEYWORD_TEXT));
        nameValues.put(String(NO_NORMS_KEY), String(NO_NORMS_TEXT));
        nameValues.put(String(NO_TF_KEY), String(NO_TF_TEXT));
        nameValues.put(String(UNINDEXED_FIELD_KEY), String(UNINDEXED_FIELD_TEXT));
        nameValues.put(String(UNSTORED_FIELD_1_KEY), String(UNSTORED_1_FIELD_TEXT));
        nameValues.put(String(UNSTORED_FIELD_2_KEY), String(UNSTORED_2_FIELD_TEXT));
