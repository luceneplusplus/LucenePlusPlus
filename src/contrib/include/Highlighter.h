...
namespace Lucene
{
    ...
    /// Formatter}, {@link Encoder} and tokenizers.
    ...
    public:
        ...
        /// section. This is a convenience method that calls {@link
        /// #getBestFragment(TokenStreamPtr, const String&)}
        ///
        ...
        /// Highlights chosen terms in a text, extracting the most relevant
        /// section. The document text is analyzed in chunks to record hit
        /// statistics across the document. After accumulating stats, the fragment
        ...
        /// TokenStreams more efficiently by adding support for storing original
        /// text position data in the Lucene index but this support is not
        /// currently available.
        /// @param text Text to highlight terms in
        /// @return highlighted text fragment or null if no terms found
        ...
        /// #getBestFragments(TokenStreamPtr, const String&, int32_t)}
        ///
        /// @param analyzer The analyzer that will be used to split text into
        /// chunks
        ...
        /// Highlights chosen terms in a text, extracting the most relevant sections.
        /// The document text is analyzed in chunks to record hit statistics
        ...
        /// document. This method has been made public to allow visibility of
        /// score information held in TextFragment objects.
        ...
        /// merging any fragments that were contiguous in the original text into
        /// one larger fragment with the correct order.  This will leave a "null"
        /// in the array entry for the lesser scored fragment.
        ///
        ...
        /// "...").  The document text is analyzed in chunks to record hit
        /// statistics across the document.  After accumulating stats, the
        /// fragments with the highest scores are returned in order as "separator"
        /// delimited strings.
        ///
        /// @param text Text to highlight terms in
        /// @param maxNumFragments The maximum number of fragments.
