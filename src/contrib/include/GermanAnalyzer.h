...
namespace Lucene
{
    ...
    public:
        ...
        GermanAnalyzer(LuceneVersion::Version matchVersion, SetString stopwords);

        /// Builds an analyzer with the given stop words and stemming exclusion words.
        GermanAnalyzer(LuceneVersion::Version matchVersion, SetString stopwords, SetString exclusions);
