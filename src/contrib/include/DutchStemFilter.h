...
namespace Lucene
{
    ...
    public:
        ...
        DutchStemFilter(TokenStreamPtr input, SetString exclusiontable);

        /// Builds a DutchStemFilter that uses an exclusion table and dictionary of word stem
        /// pairs, that overrule the algorithm.
        DutchStemFilter(TokenStreamPtr input, SetString exclusiontable, MapStringString stemdictionary);
    ...
    public:
        ...
        void setExclusionSet(SetString exclusiontable);
