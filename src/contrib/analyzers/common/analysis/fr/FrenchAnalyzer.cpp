...
namespace Lucene
{
    ...
    const wchar_t* FrenchAnalyzer::_FRENCH_STOP_WORDS_DEFAULT[] =
    {
        ...
        L"eux", L"il", L"je", L"la", L"le", L"leur", L"lui", L"ma", L"mais", L"me", L"m\x00eame",
        ...
        L"m", L"n", L"s", L"t", L"y", L"\x00e9t\x00e9", L"\x00e9t\x00e9e", L"\x00e9t\x00e9es",
        L"\x00e9t\x00e9s", L"\x00e9tant", L"suis", L"es", L"est", L"sommes", L"\x00eates", L"sont",
        L"serai", L"seras", L"sera", L"serons", L"serez", L"seront", L"serais", L"serait", L"serions",
        L"seriez", L"seraient", L"\x00e9tais", L"\x00e9tait", L"\x00e9tions", L"\x00e9tiez",
        L"\x00e9taient", L"fus", L"fut", L"f\x00fbmes", L"f\x00fbtes", L"furent", L"sois", L"soit",
        L"soyons", L"soyez", L"soient", L"fusse", L"fusses", L"f\x00fbt", L"fussions", L"fussiez",
        ...
        L"avaient", L"eut", L"e\x00fbmes", L"e\x00fbtes", L"eurent", L"aie", L"eirs", L"ait",
        L"ayons", L"ayez", L"aient", L"eusse", L"eusse", L"eusses", L"e\x00fbt", L"eussions",
        L"eussiez", L"eussent", L"ceci", L"cel\x00e0\x00a0", L"cet", L"cette", L"ici", L"ils",
