...
namespace Lucene
{
    ...
    bool FrenchStemmer::step2a()
    {
        ...
        if (!search)
        {
            ...
            search = Collection<String>::newStaticInstance(_search, _search + SIZEOF_ARRAY(_search));
        }
    ...
    void FrenchStemmer::step2b()
    {
        ...
        if (!suffix)
        {
            ...
            suffix = Collection<String>::newStaticInstance(_suffix, _suffix + SIZEOF_ARRAY(_suffix));
        }
